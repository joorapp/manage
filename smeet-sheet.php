...
$sqlQuery = "SELECT * FROM {$prefix}enquiries where status_id = 2".$roleCondition;
			  ...
			  <div class="row for_overflow">
					<div class="col-lg-12 grid-margin stretch-card">
					  <div class="card for_box_shadow">
						<div class="card-body">
						  <h4 class="card-title">Meeting list of <?php echo $totalRecords .' '. $record; ?> </h4>
...
function delete_id(id)
{
     ...
     {
        window.location.href='smeet-sheet?delete_id='+id;
     }
}
</script>
...
if(isset($_GET['delete_id']))
	...
	mysqli_query($conn, $sql);
	 ...
	 echo '<script> alert("Details has been successfully deleted.")</script>';
	 echo '<script type="text/javascript">
	window.location.href = "smeet-sheet"
	</script>'; 
	} 
?>
...
function edit_id(id)
{
    window.location.href='smeet-sheet?edit_id='+id;
...
if(isset($_POST['meet_update_submit'])){
...
<!-- Edit meet details modal starts -->			  
<div class="modal fade" id="edit_meet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width:700px ! important;">
    <div class="modal-content modal-bg">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Meeting Details - <?php echo $row['enquiry_id']; ?></h5>
      ...
      <div class="modal-body padding-lr0">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
                <div class="card-body">           
                  <form class="forms-sample" action="smeet-sheet" method="post" enctype="multipart/form-data">
 ...
 <textarea class="form-control"  name="comments" rows="4"><?php echo $row['comments']; ?></textarea>
                    ...
                    <button type="submit" name="meet_update_submit" class="btn btn-info mr-2">Update</button>
