...
$sqlQuery = "SELECT * FROM {$prefix}enquiries where status_id = 6 ".$roleCondition;
			  ...
			  <div class="row for_overflow">
					<div class="col-lg-12 grid-margin stretch-card">
					  <div class="card for_box_shadow">
						<div class="card-body">
						  <h4 class="card-title">Nil list of <?php echo $totalRecords .' '. $record; ?> </h4>
...
function edit_id(id)
{
    window.location.href='snil-sheet?edit_id='+id;
...
if(isset($_POST['nil_update_submit'])){	
 ...
 echo '<script type="text/javascript">
	window.location.href = "snil-sheet"
	</script>';	
}
?>

<!-- Edit enquiry modal starts -->			  
<div class="modal fade" id="edit_nil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width:700px ! important;">
    <div class="modal-content modal-bg">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Nil Details - <?php echo $row['enquiry_id']; ?></h5>
      ...
      <div class="modal-body padding-lr0">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
                <div class="card-body">           
                  <form class="forms-sample" action="snil-sheet" method="post" enctype="multipart/form-data">
 ...
 <textarea class="form-control"  name="comments" rows="4"><?php echo $row['comments']; ?></textarea>
                    ...
                    <button type="submit" name="nil_update_submit" class="btn btn-info mr-2">Update</button>
