...
<!-- Accounts Manager My profile modal starts -->			  
    ...
    <div class="modal-content modal-bg">
      ...
      <div class="modal-body padding-lr0">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
			  <div class="card-body">
				<form class="forms-sample" action="accountm-dashboard" method="post" enctype="multipart/form-data">			  
...
<!-- Accounts  Manager My profile modal ends -->
